...
var VerticesToVerticesPipe = require('./pipes/lmdb-vertices-to-vertices-pipe'),
  ...
  PathPipe = require('./pipes/lmdb-path-pipe'),
  //PathPipe = require(process.cwd()+'/node_modules/ngraph.shremlin/lib/pipes/pathPipe'),
...
exports.augmentVerticesPipes = function(srcPipePrototype) {
  /**
...
exports.augmentEdgesPipes = function(srcPipePrototype) {
  /**
...
// --------------------------
exports.augmentGenericPipe = function(srcPipePrototype) {
  /**
