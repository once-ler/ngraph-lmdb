 ...
 */
var VerticesToVerticesPipe = require('./pipes/edges-to-vertices-pipe'),
    VertexPipe = require('./pipes/edges-to-vertices-pipe'),
    PathPipe            = require('../node_modules/ngraph.shremlin/lib/pipes/pipes/pathPipe'),
    EdgesToVerticesPipe = require('./pipes/edges-to-vertices-pipe'),
    VerticesToEdgesPipe = require('./pipes/vertices-to-edges-pipe');
