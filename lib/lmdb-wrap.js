...
module.exports = function(config) {
  ...
  function VertexCursor() {
    this.txn = env.beginTxn();
    this.cursor = new lmdb.Cursor(this.txn, vertexDb);
    //this._current = this.cursor.goToFirst();
    this.index = -1;  
  };
  VertexCursor.prototype.moveNext = function() {
    this.index++;
  ...
  VertexCursor.prototype.current = function(callback) {
  ...
  VertexCursor.prototype.close = function() {
    this.cursor.close();
    this.txn.abort();
  };
