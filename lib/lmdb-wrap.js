...
modules.exports = function(config) {
  ...
  Bulkload.prototype.addNode = function(nodeId, data) {
    var buffer = new Buffer(typeof data == 'string' ? data : JSON.stringify(data));
    this.txn.putBinary(vertexDb, key, buffer);
    lmdbWrap.incrNumber(statsDb,'nodesCount');
  };
  Bulkload.prototype.addLink = function (fromId, toId, data) {
  ...
  Bulkload.prototype.commit = function() {
    this.txn.commit();
  };
