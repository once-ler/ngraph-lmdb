...
module.exports = function (config) {
  ...
  var getNumber = function (dbi, key, callback) {
    dbi.get(key, {asBuffer: false}, function (err, value) {
      if (err) {
  ...
  var putNumber = function (dbi, key, value, callback) {
    dbi.put(key, value+'', {asBuffer: false}, function (err) {
      if (err) {
        throw err;
      }
      if (callback) {
  ...
  var getNode = function (nodeId, callback) {
    ...
    vertexDb.get(nodeId, {asBuffer:false}, function (err, value) {
      if (err) {
  ...
  var getLink = function (edgeId, callback) {
    ...
    edgeDb.get(edgeId, {asBuffer:false}, function (err, value) {
      if (err) {        
        return callback(null,null);
      }
      var retval = value;
  ...
  var addNode = function (nodeId, data, callback) {
    ...
    async.waterfall([
      ...
      function (node, cb) {
        ...
        vertexDb.put(nodeId, JSON.stringify(node), {asBuffer: false}, function (err) {
          cb(null, node);
        })
      }
    ], function (err, node) {
  ...
  var createLink = function (fromId, toId, data, callback, linkId, fromNode, toNode) {
    ...
    async.parallel([
        ...
        function (cb2) {
          edgeDb.put(linkId, link, {asBuffer: false}, cb2);
        },
        function (cb2) {
        ...
        function (cb2) {
          ...
          vertexDb.put(fromId, fromNode, {asBuffer: false}, cb2);
        },
        function (cb2) {
          toNode.links.push(link);
          vertexDb.put(toId, toNode, {asBuffer: false}, cb2);
        }
      ],
      function (err) {
  ...
  return {
    ...
    forEachNode: function (callback) {
      ...
      var it = edgeDb.iterator({ keyAsBuffer: false, valueAsBuffer: false }),
        fn = function(err, key, data) {

          if (key && data){
            if (callback(JSON.parse(data))){
              it.end(function () {});  
            }
            else {
    ...
    clear: function (callback) {
      ...
      async.parallel([
        ...
        function (cb) {
          statsDb.put('nodesCount', 0, {asBuffer: false}, cb);
        },
        function (cb) {
          dispose(edgeDb, cb);
        },
        function (cb) {
          statsDb.put('linksCount', 0, {asBuffer: false}, cb);
        },
        function (cb) {
