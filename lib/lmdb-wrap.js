...
module.exports = function(config) {
  ...
  var indexVertexEngine = lmdbIndex()
    .init(lmdbWrapHelper.env, lmdbWrapHelper.indexVertexDb);
  var indexEdgeEngine = lmdbIndex()
    .init(lmdbWrapHelper.env, lmdbWrapHelper.indexEdgeDb);
    ...
    for(var k in links){
      ...
      if (link){
        ...
        if (direction == 'both'){
          ...
          var cursor1 = new lmdb.Cursor(txn1, direction == 'in' ? lmdbWrapHelper.inEdgeDb : lmdbWrapHelper.outEdgeDb);
