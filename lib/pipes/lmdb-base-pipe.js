...
LmdbBasePipe.prototype.moveNext = function () {
  ...
  if (this._moveNext()) {
    ...
    /** verticesToVertices will have both _currentEdgesIterator and _currentVerticesIterator
     * _currentVerticesIterator should trump _currentEdgesIterator
     **/
    if (this._currentVerticesIterator){
      this._currentVerticesIterator.current(function(err, d) {
        self._current = d;
      });
    }
    if(!this._currentVerticesIterator && !this._currentEdgesIterator) {
...
/**
  Note, getCurrentPath and getPathToHere is now same as original version :)
*/
